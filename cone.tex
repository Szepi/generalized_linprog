...
\begin{algin}
(\Gamma J^*-\hg J^*)(i) &=\phi(i) r^s_{\Gamma}- \phi(i) r^s_{\Gamma}
...
= \phi(i) r^i_{\Gamma}- J^*(i)+ J^*(i) -\underset{j\in \J}|\gamma_j| J^*(j) + \underset{j\in \J} (|\gamma_j|-\gamma_j)B
\end{align}
\end{proof}
