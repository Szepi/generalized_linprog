...
In this section, we show via an example in the domain of controlled queues that the error term $\et$ indicates \todoc{right word?}
...
(and intractable) sampler of \citep{CS}. \todoc{Right??}
