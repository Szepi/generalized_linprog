...
Let the set of states, or state space be $\S = \{1,2,\dots,S\}$ and let the set of actions be $\A = \{1,2,\dots,A\}$. \todoc{$\S$ is for state space, $S$ for number of states, $\A$, $A$, similarly. Thus, $S=n$, $A=d$.}
