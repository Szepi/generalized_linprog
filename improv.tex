...
Let $r^*\in \R^k$ be defined as $r^*\stackrel{\Delta}{=}\argmin_{r\in R^k}||J^*-\Phi r||_{\infty,1/\psi}$, then 
\begin{align}
...
Let $\hv$, $\bj$ be as in Theorem~\ref{mt1} and let $r^*\stackrel{\Delta}{=}\argmin_{r\in \R^k}||J^*-\Phi r||_{\infty,1/\psi}$ then
\begin{align}
