...
The LUB projection of $J^*$ is denoted by $\bj=\Gamma J^*$. \todoc{It is a bit strange to call this a definition. A numbered equation could be enough.}
\end{definition}
...
= \{ y\,: \, \Phi y \geq TJ, y \in \N \}$. \todoc{This is where this assumption is needed.}
\end{proof}
...
%Let $\Phi r_1, \Phi r_2,\ldots,\Phi r_n$ be solutions to the ALP in \eqref{alp} for $c=e_1, e_2,\ldots,e_n$ respectively. 
