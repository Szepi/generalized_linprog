...
\end{align}
From Assumption~\ref{one} there exists $r'= r^*+\frac{(1+\alpha)\gamma}{1-\alpha}\one$ and $r'$ is feasible to the ALP. \todoc{Why not just state that let $r' = r^* + \frac{(1+\alpha)\gamma}{1-\alpha} e_1$?}
Now
\begin{align}
